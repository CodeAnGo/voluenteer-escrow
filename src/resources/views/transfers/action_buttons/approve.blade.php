...
<form class="hidden" action="{{ route('transfers.update.status', [$transfer->id, \App\TransferStatusTransitions::ToApproved]) }}" method="POST" id="approveForm">
    @csrf
</form>
