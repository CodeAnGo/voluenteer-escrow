...
<form class="hidden" action="{{ route('transfers.update.status', [$transfer->id, \App\TransferStatusTransitions::ToAwaitingAcceptance]) }}" method="POST" id="restartForm">
    @csrf
</form>
