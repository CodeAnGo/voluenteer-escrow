...
<form class="hidden" action="{{ route('transfers.update.status', [$transfer->id, \App\TransferStatusTransitions::ToAccepted]) }}" method="POST" id="acceptForm">
    @csrf
</form>
