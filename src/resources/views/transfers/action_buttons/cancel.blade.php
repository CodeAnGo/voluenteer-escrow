...
<form class="hidden" action="{{ route('transfers.update.status', [$transfer->id, \App\TransferStatusTransitions::ToCancelled]) }}" method="POST" id="cancelForm">
    @csrf
</form>
