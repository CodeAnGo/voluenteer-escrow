    ...
    <div class="relative max-w-screen-xl mx-auto pt-20 pb-12 px-4 sm:px-6 lg:px-8 lg:py-20">
        ...
        <div class="relative lg:flex lg:items-center">
            <div class="hidden lg:block lg:flex-shrink-0">
                <img class="h-64 w-64 rounded-full xl:h-80 xl:w-80 object-center" src="{{ asset('img/andre.png') }}" alt="" />
            </div>
                    ...
                    <footer class="mt-8">
                        <div class="flex">
                            <div class="flex-shrink-0 lg:hidden">
                                <img class="h-12 w-12 rounded-full" src="{{ asset('img/andre.png') }}" alt="" />
                            </div>
                            <div class="ml-4 lg:ml-0">
                                <div class="text-base leading-6 font-medium text-gray-900">André Rogaczewski</div>
                                <div class="text-base leading-6 font-medium text-indigo-600">Chief Executive of Netcompany</div>
                            </div>
                        </div>
                    </footer>
                </blockquote>
